...
import pe.edu.upeu.proyectointegrador.daoImpl.CapacitadorDaoImpl;
 ...
 * @author Alvaro Alva
 */
@WebServlet(name = "CapacitadorController", urlPatterns = {"/cc"})
public class CapacitadorController extends HttpServlet {
private Gson gson = new Gson();
	private CapacitadorDao udao = new CapacitadorDaoImpl();
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		switch (op) {
			...
			out.println(gson.toJson(udao.create(new Capacitador(e,q))));
			break;
                case 3://read
			...
			Capacitador a = new Capacitador();
                       a.setIdcapacitador(Integer.parseInt(request.getParameter("i")));
                       a.setEspecialidad(request.getParameter("b"));
